...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.5 -->
        <link rel="stylesheet" href="../dashboard/lte/bootstrap/css/bootstrap.min.css">
        <!-- Font Awesome -->
        ...
        <!-- DataTables -->
        <link rel="stylesheet" href="../dashboard/lte/plugins/datatables/dataTables.bootstrap.css">

        <!-- Theme style -->
        <link rel="stylesheet" href="../dashboard/lte/dist/css/AdminLTE.min.css">
        <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
              page. However, you can choose any other skin. Make sure you
              apply the skin class to the body tag so the changes take effect.
        -->
        <link rel="stylesheet" href="../dashboard/lte/dist/css/skins/skin-blue.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="../dashboard/lte/plugins/datepair-this/jquery.timepicker.css" /> 
    ...
    <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
        ...
        <!--DatePicker-->
        <script src="../dashboard/lte/plugins/datepicker/bootstrap-datepicker.js"></script>
        <script src="../dashboard/lte/plugins/timepicker/bootstrap-timepicker.min.js"></script>
        <!--DatePair-->
        <script src="../dashboard/lte/plugins/datepair-this/jquery.timepicker.js"></script>
        <script src="../dashboard/lte/plugins/datepair-this/bootstrap-datepicker.js"></script>
        <script src="../dashboard/lte/plugins/datepair-this/datepair.js"></script>
        <script src="../dashboard/lte/plugins/datepair-this/jquery.datepair.js"></script>
